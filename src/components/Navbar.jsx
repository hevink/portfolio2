...
const Navbar = () => {
    ...
    return (
        <div data-aos='fade-down' className='flex border-b-slate-900 justify-between items-center w-full h-20 px-4 text-black bg-[#EBFEFF] fixed  z-20' >
            <div>
                <h1 className='text-5xl md:ml-10'>Hevin.Dev</h1>
            </div>
            <ul className=' hidden md:flex md:mr-10'>
                <li className='px-4 cursor-pointer capitalize font-medium  hover:scale-110 duration-200'>   <Link to="hero" spy={true} smooth={true} offset={-100} duration={500}>Home</Link></li>
            ...
            <div onClick={() => setnavbar(!navbar)} className='z-10 text-white cursor-pointer md:hidden'>
                {/* <MenuIcon /> */}
